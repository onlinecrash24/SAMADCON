...
def test_a_reference_we_cannot_resolve_is_kept_as_it_is():
    """It names a template that may be installed later, and half an answer
    beats none."""
    ...
    # Unresolvable prefixes are left alone rather than dropped.
    assert catalogue_text(loaded, "X:P") == "elsewhere:SUPPORTED_Something"
