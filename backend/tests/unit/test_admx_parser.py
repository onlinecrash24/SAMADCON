...
def test_a_reference_we_cannot_resolve_is_not_passed_off_as_an_answer():
    ...
    and is the opposite of true. Nothing is shown in its place either: the
    namespace is installable nowhere, so naming it only moves the noise.
    """
...
def test_a_policy_that_names_no_requirement_says_nothing_either():
    admx = b"""<?xml version="1.0"?>
    <policyDefinitions xmlns="http://schemas.microsoft.com/GroupPolicy/2006/07/PolicyDefinitions">
