...
from samcon.ad.access import ad_read
from samcon.auth import kerberos
from samcon.auth.deps import CurrentSession, client_ip
from samcon.auth.session import get_store, get_throttle
from samcon.config import get_settings
from samcon.core.audit import get_audit
from samcon.core.errors import AuthenticationError, SamconError
from samcon.core.executor import get_registry
from samcon.schemas.requests import LoginRequest
...
async def login(payload: LoginRequest, request: Request, response: Response) -> dict[str, Any]:
    ...
    def _fail(exc: SamconError, principal_name: str | None, target: Any = None) -> None:
...
async def whoami(session: CurrentSession) -> dict[str, Any]:
    ...
    """
    from samcon.ad import groups as groups_module
    from samcon.ad.connection import SCOPE_SUBTREE
    from samcon.ad.directory import summarize
    from samcon.ad.values import escape_filter
