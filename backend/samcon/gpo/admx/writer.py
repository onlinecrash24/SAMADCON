...
from samcon.core.errors import Conflict, InvalidRequest, SamconError
from samcon.gpo import container, cse, registry_pol, sysvol
from samcon.gpo.admx import resolver
from samcon.gpo.admx.model import Policy
...
def register_extension(conn: DirectoryConnection, dn: str, half: str) -> str | None:
    ...
    The list itself lives in ``samcon.gpo.cse``: scripts and folder
