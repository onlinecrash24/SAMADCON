...
Everything else in SAMADCON speaks LDAP. This module is the exception: the files
...
from samadcon.core.errors import InvalidRequest, SamadconError, translate
...
def _translate_smb(exc: Exception, path: str) -> SamadconError:
