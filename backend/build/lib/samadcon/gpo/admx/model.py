...
class Catalogue:
    ...
    def supported_text(self, policy: Policy) -> str | None:
        ...
        Nor is the raw reference offered anywhere else. It names a namespace
        generated by the tool that built the template and installable nowhere,
        so showing it as a diagnostic only moves the noise.
        """
